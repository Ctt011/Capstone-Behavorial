...
% \begin{figure}[H]
% \centering
% \includegraphics[width=0.9\linewidth]{stress_by_phase.png}
...
% \begin{figure}[H]
% \centering
% \includegraphics[width=1\linewidth]{S04_signals.png}
% \caption{Physiological responses for Subject S04 during the V1 stress protocol. Colored regions indicate STRESS phases (Stroop, TMCT, Opinion tasks, Subtract). Visible patterns include EDA spikes during TMCT, elevated heart rate during cognitive tasks, and increased accelerometer activity during speeches.}
% \label{fig:subject_signals}
% \end{figure}
